...
```
cd existing_repo
git remote add origin https://gitlab.com/fmorriso/python-pyside6-tutorial.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/fmorriso/python-pyside6-tutorial/-/settings/integrations)
